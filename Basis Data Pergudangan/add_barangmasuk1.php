...
<body>
	...
	<div class="container">
		...
		<form action="add_barangmasuk1.php" method="post" name="form1">
		...
		if (isset($_POST['Submit'])) {
			...
			$result = mysqli_query($mysqli, "INSERT INTO t_supplier(id_sup, nama_sup, alamat) VALUES('$id_sup', '$nama_sup', '$alamat')");
