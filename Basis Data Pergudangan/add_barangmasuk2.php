...
<body>
	...
	<h3>Silahkan Masukkan Data</h3>
		<form action="add_barangmasuk2.php" method="post" name="form1">
			<table width="50%" border="0">
				<tr>
					<td>Id Pemasokan Supplier</td>
					<td><input type="text" name="id_pemasokan_supplier"></td>
				</tr>
		...
		if (isset($_POST['Submit'])) {
			...
			$result = mysqli_query($mysqli, "INSERT INTO pemasokan_supplier(id_pemasokan_supplier, id_bar, id_sup, tanggal, jumlah) VALUES('$id_pemasokan_supplier', '$id_bar', '$id_sup', '$tanggal','$jumlah')");

			// Show message when user added
			echo "User added successfully. <a href='home_barangmasuk.php'>View Users</a>";
		}
		?>
		<br>
