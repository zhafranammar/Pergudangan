	...
	<div class="container">
		...
		<form action="add_staff.php" method="post" name="form1">
			<table width="50%" border="0">
				...
				<tr>
					<td>Nama Staff</td>
					<td><input type="text" name="nama_staff"></td>
				</tr>
				<tr>
					<td>Alamat Staff</td>
		...
		if (isset($_POST['Submit'])) {
			...
			$result = mysqli_query($mysqli, "INSERT INTO t_staff(id_staff, id_ged, nama_staff, alamat, umur) VALUES('$id_staff','$id_ged','$nama_staff', '$alamat', '$umur')");

			// Show message when user added
			echo "Data berhasil ditambahkan  <a class='btn btn-primary' href='home_staff.php'>Lihat Data</a>";
		}
		?>
		<br></br>
