...
<body>
	...
	<div class="container">
		...
		<form action="add_barangkeluar1.php" method="post" name="form1">
			<table width="50%" border="0">
				...
				<tr>
					...
					<td><input type="text" name="nama_distr"></td>
				</tr>
				<tr>
					<td>Alamat</td>
		...
		if (isset($_POST['Submit'])) {
			...
			$result = mysqli_query($mysqli, "INSERT INTO t_distributor(id_distr, nama_distr, alamat) VALUES('$id_distr', '$nama_distr', '$alamat')");
