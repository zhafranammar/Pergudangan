...
<body>
	...
	<div class="container">
		...
		<form action="add_gedung.php" method="post" name="form1">
			<table width="50%" border="0">
				...
				<tr>
					<td>Nama Gedung</td>
					<td><input type="text" name="nama_ged"></td>
				</tr>
				<tr>
					<td>Kapasitas</td>
		...
		if (isset($_POST['Submit'])) {
			...
			$result = mysqli_query($mysqli, "INSERT INTO t_gedung(id_ged,nama_ged,kapasitas) VALUES('$id_ged','$nama_ged','$kapasitas')");

			// Show message when user added
			echo "Data berhasil ditambahkan  <a class='btn btn-primary' href='home_gedung.php'>Lihat Data</a>";
		}
		?>
		<br>
